...
const Hero = () => {
  ...
  return (
    <section 
      id="home" 
      className={`flex items-start lg:items-center relative overflow-hidden transition-all duration-300 min-h-[calc(100vh-76px)] py-10`}
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-6 pb-4">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          >
            ...
            >
              HELLO ,<span className="wave-emoji text-2xl mx-1 z-10 relative">👋</span>
            ...
            >
              <button
                ...
                className="px-6 py-3 bg-gradient-to-r from-primary to-secondary rounded-xl font-semibold transition-all duration-300"
              >
                Download Resume
              </button>
              <a
               href="#contact"
               className="px-6 py-3 border border-primary rounded-xl font-semibold hover:bg-primary/10 transition-all duration-300 text-center"
              >
                Contact Me
              </a>
            </motion.div>
